...
return new class extends Migration {
  public function up(): void {
    Schema::table('users', function (Blueprint $t) {
      ...
      if (!Schema::hasColumn('users','role'))     $t->string('role')->default('Docente')->after('phone');
      if (!Schema::hasColumn('users','status'))   $t->string('status')->default('PENDIENTE')->after('role');
      if (!Schema::hasColumn('users','must_change_password')) $t->boolean('must_change_password')->default(true)->after('status');
